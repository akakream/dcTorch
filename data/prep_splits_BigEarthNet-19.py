...
# python prep_splits_BigEarthNet-19.py -r /workspace/fast_data/BigEarthNet-v1.0 -o /workspace/data/BigEarthNet19/ -n ./splits/test.csv ./splits/train.csv ./splits/val.csv
